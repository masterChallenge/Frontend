const challenge_data = {
  id: 1,
  name: "",
  description: "La propiedad background-color se utiliza para cambiar el color de fondo del elemento, el reto es cambiar el background-color del elemento a rojo",
  abilitie: [
  ...
  challenge: {
    ...
    output: [
      ...
      {
        language: "css",
        value: ".final_divLayout { width: 300px; height: 300px; } .final_divHola { background-color: red; width: 50px; height: 50px; }"
      },
      {
        language: "js",
        value: ""
